      ...
      var i = ["dragover", "dragleave", "drop"];return function () {
        function n() {
          var i = arguments.length <= 0 || arguments[0] === e ? document.createElement("div") : arguments[0];t(this, n), this._element = i, this._accept = [], this._dragPath = null, this._init();
            ...
            if (this._element.className == "slim-file-hopper") return;this._element.style.display = t ? "" : "none";
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/_css-loader@0.28.10@css-loader/index.js!./slim.css", function() {
			var newContent = require("!!../../../../../node_modules/_css-loader@0.28.10@css-loader/index.js!./slim.css");
