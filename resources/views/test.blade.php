...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="Laravel News » Feed" href="https://feed.laravel-news.com/">
    ...
    <link rel="stylesheet" href="/css/all-e2806f5b0e.css">
</head>
        ...
        <div class="container wrapper">
            <div class="nav__header">
                <a class="nav__logo" href="https://laravel-news.com">
                    ...
                    <p class="logo__title">Laravel News</p>
                </a>
                <button type="button" class="nav__hamburger js-menu-toggle" _vimium-has-onclick-listener="">
        ...
        <div class="container wrapper py4 md-py6">
            <div class="category mb4">
                ...
                <div class="gutter grid--2-col lg-grid--3-col grid--left">
                    ...
                    <a href="/collision" class="card col mb1 sm-mb2">
                        <div class="card__image">
                    ...
                    <a href="/laravel-agron2i" class="card col mb1 sm-mb2">
                        <div class="card__image">
            ...
            <div class="category mb4">
                ...
                <div class="gutter grid--2-col lg-grid--3-col grid--left">
                    ...
                    <a href="/trusted-proxy" class="card col mb1 sm-mb2">
                        <div class="card__image">
                    ...
                    <a href="/viewfirst" class="card col mb1 sm-mb2">
                        <div class="card__image">
            ...
            <div class="category mb4">
                ...
                <div class="gutter grid--2-col lg-grid--3-col grid--left">
                    ...
                    <a href="/lets-encrypt-wildcard-ssl-certificates-are-here" class="card col mb1 sm-mb2">
                        <div class="card__image">
                    ...
                    <a href="/scaling-laravel" class="card col mb1 sm-mb2">
                        <div class="card__image">
                            <img src="https://i1.wp.com/wp.laravel-news.com/wp-content/uploads/2018/03/scaling-laravel.jpg?resize=1400%2C709" alt="The Scaling Laravel Course by Chris Fidao is now Live">
                        </div>
                        <div class="card__content">
                            <span class="label">Mar 13, 2018</span>
                            <h4>The Scaling Laravel Course by Chris Fidao is now Live</h4>
                        </div>
                    </a>
                </div>
            </div>
            <div class="category mb4">
                ...
                <div class="gutter grid--2-col lg-grid--3-col grid--left">
                    <a href="/uploading-avatar-images" class="card col mb1 sm-mb2">
                        <div class="card__image">
                            <img src="https://i2.wp.com/wp.laravel-news.com/wp-content/uploads/2018/03/avatar-images-spatie.png?resize=1400%2C709" alt="Uploading Avatar Images with Spatie’s Media Library">
                        </div>
                        <div class="card__content">
                            <span class="label">Mar 23, 2018</span>
                            <h4>Uploading Avatar Images with Spatie’s Media Library</h4>
                        </div>
                    </a>
                    <a href="/signed-routes" class="card col mb1 sm-mb2">
                        <div class="card__image">
                            <img src="https://i0.wp.com/wp.laravel-news.com/wp-content/uploads/2018/03/signed-routes.png?resize=1400%2C709" alt="Getting Started with Signed Routes in Laravel">
                        </div>
                        <div class="card__content">
                            <span class="label">Mar 21, 2018</span>
                            <h4>Getting Started with Signed Routes in Laravel</h4>
                        </div>
                    </a>
            ...
            <div class="category mb4">
                ...
                <div class="gutter grid--2-col lg-grid--3-col grid--left">
                    <a href="/laravel-excel-3-0" class="card col mb1 sm-mb2">
                        <div class="card__image">
                            <img src="https://i2.wp.com/wp.laravel-news.com/wp-content/uploads/2018/03/laravel-excel.png?resize=1400%2C709" alt="Laravel Excel 3.0">
                        </div>
                        <div class="card__content">
                            <span class="label">Mar 22, 2018</span>
                            <h4>Laravel Excel 3.0</h4>
                        </div>
                    </a>
                    ...
                    <a href="/guzzle-advanced-throttling-middleware" class="card col mb1 sm-mb2">
                        <div class="card__image">
    ...
    <footer class="site-footer">
        <div class="container wrapper">
            <ul class="social social--lg">
                <li>
                    <a rel="nofollow" href="https://twitter.com/laravelnews" class="social__icon icon--twitter">
                        <svg>
                ...
                <li>
                    <a rel="nofollow" href="https://www.facebook.com/laravelnews" class="social__icon icon--facebook">
                        <svg>
                ...
                <li>
                    <a rel="nofollow" href="https://plus.google.com/+Laravel-news/posts" class="social__icon icon--google">
                        <svg>
                ...
                <li>
                    <a rel="nofollow" href="https://instagram.com/laravelnews" class="social__icon icon--instagram">
                        <svg>
                ...
                <li>
                    <a rel="nofollow" href="https://www.linkedin.com/company/laravel-news" class="social__icon icon--linkedin">
                        <svg>
            ...
            <div class="footer__copy mt5">
                ...
                <p>© 2012 - 2018 <a href="/">Laravel News</a> — By <a href="https://twitter.com/ericlbarnes">Eric L. Barnes</a> - A division of dotdev inc.</p>
            </div>
