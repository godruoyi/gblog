...
<head>
    ...
    <link rel="stylesheet" href="/vendor/css/zhihu.css">
</head>
<body class="EntrySign-body">
    <div id="root">
        <div>
            <main role="main" class="App-main">
                <div class="SignFlowHomepage" style="background-image:url(https://static.zhihu.com/heifetz/bg.8ca8122d44fc9a0f7b04.png);">
                    <!-- react-empty: 41 -->
